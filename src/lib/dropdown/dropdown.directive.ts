...
@Directive({ selector: '[cui-dropdown], [dropdown]' })
export class Dropdown implements OnInit, OnDestroy {
  ...
  @HostBinding('class.cui-dropdown') private addClass = true;
  ...
  constructor(
    ...
    // @ContentChildren('cui-dropdown-menu')
  ...
  public focusDropdownEntry(keyCode: number) {
    ...
    let hostEl = this.menuEl ? this.menuEl.nativeElement : this.el.nativeElement.getElementsByTagName('ul')[0];
